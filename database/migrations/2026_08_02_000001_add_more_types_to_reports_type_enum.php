...
return new class extends Migration
{
    ...
    public function up(): void
    {
        ...
        if (Schema::getConnection()->getDriverName() === 'mysql') {
            DB::statement("ALTER TABLE reports MODIFY type ENUM('blood_test', 'prescription', 'xray', 'sonography', 'mri_ct', 'insurance', 'bill', 'ecg', 'dental', 'discharge_summary', 'pathology', 'eye_care', 'other') NOT NULL");
        }
    }
