<x-app-layout>
    <x-slot name="header">
        <h2 class="text-2xl font-bold leading-tight tracking-tight text-nivayalife-ink dark:text-white">Upload Report</h2>
                        ...
                        <div class="min-w-0 flex-1">
                            ...
                            <div class="mt-3" x-show="f.status !== 'uploading' && f.status !== 'done' && f.status !== 'duplicate'">
                                <p x-show="f.detecting" class="mb-2 flex items-center gap-1.5 text-xs font-medium text-nivayalife-muted">
                                    ...
                                    Reading with AI&hellip;
                                </p>
                                <p x-show="!f.detecting && f.autoDetected" x-cloak class="mb-2 inline-flex items-center gap-1 rounded-full bg-nivayalife-mint/60 px-2.5 py-1 text-[11px] font-semibold text-nivayalife-green dark:bg-nivayalife-green/15 dark:text-nivayalife-mint">
                                    <svg class="h-3 w-3" viewBox="0 0 24 24" fill="none"><path d="M12 2 3.5 6v6c0 5 3.6 8.7 8.5 10 4.9-1.3 8.5-5 8.5-10V6L12 2Z" stroke="currentColor" stroke-width="1.6" stroke-linejoin="round"/><path d="m9 12 2 2 4-4" stroke="currentColor" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round"/></svg>
                                    Auto-filled by AI — check and adjust below
                                </p>
