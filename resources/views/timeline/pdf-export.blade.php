...
<style>
    ...
    .header .range { font-size: 10px; color: #CFEFEA; margin-top: 3px; }
    ...
    table.data th { text-align: left; font-size: 9px; text-transform: uppercase; color: #5C7876; padding: 4px 6px; border-bottom: 1px solid #DCE8E6; }
    table.data td { padding: 5px 6px; border-bottom: 1px solid #E8F3F1; font-size: 10px; }
    .muted { color: #5C7876; }
    .footer { margin-top: 20px; border-top: 1px solid #DCE8E6; padding-top: 8px; font-size: 9px; color: #5C7876; }
</style>
</head>
<body>
