...
<div x-data="{ open: false }" class="relative">
    ...
    <div x-show="open" x-cloak
        ...
        class="absolute right-0 z-30 mt-2 w-80 max-w-[calc(100vw-2rem)] overflow-hidden rounded-nivayalife border-t-2 border-nivayalife-gold/50 bg-white shadow-nivayalife dark:bg-nivayalife-night">
