...
>
    ...
    <div x-show="loaded" x-cloak>
        <label class="mb-1.5 block text-xs font-semibold text-nivayalife-muted">Country{{ $required ? ' *' : ' (optional)' }}</label>
    ...
    <div x-show="loaded" x-cloak>
        <label class="mb-1.5 block text-xs font-semibold text-nivayalife-muted">State{{ $required ? ' *' : ' (optional)' }}</label>
    ...
    <div x-show="loaded" x-cloak>
        <label class="mb-1.5 block text-xs font-semibold text-nivayalife-muted">City{{ $required ? ' *' : ' (optional)' }}</label>
