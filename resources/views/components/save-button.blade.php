...
<div class="flex items-center gap-3">
    <button type="submit" :disabled="saving"
        class="flex items-center gap-2 rounded-xl bg-novix-green px-6 py-2.5 text-sm font-semibold text-white shadow-novix-sm transition hover:bg-novix-green-dark disabled:opacity-60">
    ...
    <span x-show="saved" x-cloak x-transition class="flex items-center gap-1.5 text-sm font-semibold text-novix-green">
    ...
    <span x-show="errorFor('_general')" x-cloak x-text="errorFor('_general')" class="text-sm text-novix-pink-dark"></span>
</div>
