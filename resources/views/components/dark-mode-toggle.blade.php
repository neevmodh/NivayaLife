...
<button
    ...
    @click="toggle()"
    class="flex h-10 w-10 items-center justify-center rounded-full border border-novix-green/15 bg-white text-novix-ink shadow-novix-sm transition hover:bg-novix-mint/40 dark:border-white/10 dark:bg-white/10 dark:text-white"
