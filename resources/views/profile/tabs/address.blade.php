<div x-data="ajaxForm({ url: @js(route('profile.address')), csrfToken: @js(csrf_token()) })">
    <h3 class="text-lg font-bold text-novix-ink dark:text-white">Address</h3>
    <p class="mt-1 text-sm text-novix-muted">Kept on file for your records and, if ever needed, emergency responders.</p>
