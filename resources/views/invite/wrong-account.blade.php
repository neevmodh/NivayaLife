<x-message-page icon-bg="bg-novix-yellow/30" icon-color="text-novix-yellow">
    <x-slot:icon>
    ...
    <h1 class="mt-5 text-xl font-bold text-novix-ink">This invite is for a different email</h1>
    ...
    <form method="POST" action="{{ route('logout') }}" class="mt-6">
        @csrf
        <button type="submit" class="rounded-xl bg-novix-green px-6 py-2.5 text-sm font-semibold text-white shadow-novix-sm hover:bg-novix-green-dark">Log out</button>
    </form>
</x-message-page>
