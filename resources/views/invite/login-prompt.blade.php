<x-message-page>
    ...
    <h1 class="mt-5 text-xl font-bold text-nivayalife-ink">You already have a Nivaya Life account</h1>
    ...
    <a href="{{ route('login') }}" class="mt-6 inline-block rounded-xl bg-nivayalife-green px-6 py-2.5 text-sm font-semibold text-white shadow-nivayalife-sm hover:bg-nivayalife-green-dark">Log in to accept</a>
</x-message-page>
