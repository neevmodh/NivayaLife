...
<head>
    ...
    <title>You're invited to Novix</title>
</head>
                ...
                <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="max-width:520px; background-color:#ffffff; border-radius:24px; overflow:hidden; box-shadow: 0 12px 32px -12px rgba(30,90,69,0.18);">
                    ...
                    <tr>
                        <td style="padding:40px;">
                            <p style="margin:0 0 4px; font-size:13px; font-weight:700; color:#0F6A61; text-transform:uppercase; letter-spacing:0.06em;">Family invitation</p>
                            ...
                            <p style="margin:0 0 24px; font-size:15px; line-height:1.6; color:#12211F;">
                                Novix is a secure, family-oriented health record manager. {{ $inviterName }} has started a profile
                            ...
                            <p style="margin:0 0 8px; font-size:13px; color:#5C7876; text-align:center;">
                                Or copy and paste this link into your browser:
                            </p>
                            <p style="margin:0 0 24px; font-size:13px; color:#0F6A61; text-align:center; word-break:break-all;">
                                {{ $acceptUrl }}
                            </p>

                            <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="background-color:#F5FAF9; border-radius:14px; margin-top:8px;">
                                <tr>
                                    <td style="padding:16px 20px; font-size:13px; color:#5C7876;">
                                        This invitation expires on <strong style="color:#12211F;">{{ $expiresAt->format('F j, Y \a\t g:i A') }}</strong>.
