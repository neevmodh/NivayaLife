...
<body class="bg-nivayalife-cream font-sans text-nivayalife-ink antialiased dark:bg-nivayalife-night dark:text-nivayalife-cream">

    <header class="border-b border-nivayalife-green/10 bg-nivayalife-cream/90 backdrop-blur dark:bg-nivayalife-night/90">
        <div class="mx-auto flex max-w-3xl items-center justify-between px-6 py-4">
            <a href="/" class="flex items-center gap-2" aria-label="Nivaya Life home">
                <x-nivayalife-logo size="sm" />
            </a>
            <a href="{{ url('/terms') }}" class="text-sm font-medium text-nivayalife-green hover:underline">Terms of Service</a>
        </div>
    </header>

    <main class="mx-auto max-w-3xl px-6 py-12">
        <h1 class="text-3xl font-extrabold text-nivayalife-ink dark:text-white">Privacy Policy</h1>
        <p class="mt-2 text-sm text-nivayalife-muted">Last updated {{ now()->format('F j, Y') }}</p>

        <div class="mt-10 space-y-10 text-sm leading-relaxed text-nivayalife-ink/90 dark:text-white/80">

            <section>
                <h2 class="text-lg font-bold text-nivayalife-ink dark:text-white">1. What this covers</h2>
            ...
            <section>
                <h2 class="text-lg font-bold text-nivayalife-ink dark:text-white">2. Information we collect</h2>
            ...
            <section>
                <h2 class="text-lg font-bold text-nivayalife-ink dark:text-white">3. How we use it</h2>
            ...
            <section>
                <h2 class="text-lg font-bold text-nivayalife-ink dark:text-white">4. AI and third-party processing of your documents</h2>
            ...
            <section>
                <h2 class="text-lg font-bold text-nivayalife-ink dark:text-white">5. Other service providers</h2>
            ...
            <section>
                <h2 class="text-lg font-bold text-nivayalife-ink dark:text-white">6. What we don't do</h2>
            ...
            <section>
                <h2 class="text-lg font-bold text-nivayalife-ink dark:text-white">7. Security</h2>
            ...
            <section>
                <h2 class="text-lg font-bold text-nivayalife-ink dark:text-white">8. Data retention and account deletion</h2>
            ...
            <section>
                <h2 class="text-lg font-bold text-nivayalife-ink dark:text-white">9. Your choices and rights</h2>
            ...
            <section>
                <h2 class="text-lg font-bold text-nivayalife-ink dark:text-white">10. Cookies and sessions</h2>
            ...
            <section>
                <h2 class="text-lg font-bold text-nivayalife-ink dark:text-white">11. Children's information</h2>
            ...
            <section>
                <h2 class="text-lg font-bold text-nivayalife-ink dark:text-white">12. Changes to this policy</h2>
            ...
            <section>
                <h2 class="text-lg font-bold text-nivayalife-ink dark:text-white">13. Contact</h2>
                <p class="mt-2">Questions about this policy, or requests regarding your data, can be sent to <a href="mailto:support@nivayalife.app" class="text-nivayalife-green underline">support@nivayalife.app</a>.</p>
            </section>

        </div>

        <a href="/" class="mt-12 inline-block text-sm font-semibold text-nivayalife-green hover:underline">&larr; Back to Nivaya Life</a>
    </main>
